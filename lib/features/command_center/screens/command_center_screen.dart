  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(_event != null ? 'Command Center: ${_event!.name}' : 'Command Center', style: GoogleFonts.fredoka(fontWeight: FontWeight.w600, fontSize: 16, color: LitColors.bone)),
      ),
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text('Announcements', style: GoogleFonts.fredoka(fontWeight: FontWeight.bold, fontSize: 15, color: LitColors.bone)),
                  IconButton(
                    icon: const Icon(Icons.add, color: LitColors.ember, size: 20),
              ...
              if (_announcements.isEmpty)
                Padding(
                  ...
                  child: Text('No announcements posted yet.', style: GoogleFonts.plusJakartaSans(color: LitColors.ash, fontSize: 12)),
                ),
              ..._announcements.map((a) => ClayCard(
                    ...
                    child: ListTile(
                      ...
                      leading: Container(
                        ...
                        child: Icon(Icons.campaign, color: a.priority >= 3 ? LitColors.coral : LitColors.amber, size: 20),
                      ),
                      title: Text(a.title, style: GoogleFonts.plusJakartaSans(fontWeight: FontWeight.bold, color: LitColors.bone, fontSize: 13.5)),
                      subtitle: Text(
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('Incidents', style: GoogleFonts.fredoka(fontWeight: FontWeight.bold, fontSize: 15, color: LitColors.bone)),
                  IconButton(
                    icon: const Icon(Icons.add, color: LitColors.coral, size: 20),
              ...
              if (_incidents.isEmpty)
                Text('No incident reports.', style: GoogleFonts.plusJakartaSans(color: LitColors.ash, fontSize: 12)),
              ..._incidents.map((i) => ClayCard(
                    margin: const EdgeInsets.only(bottom: 10),
                    borderColor: i.resolved ? LitColors.moss.withOpacity(0.4) : LitColors.coral.withOpacity(0.4),
                    child: ListTile(
                      contentPadding: EdgeInsets.zero,
                      leading: Icon(
                      ...
                      title: Text(i.title, style: GoogleFonts.plusJakartaSans(fontWeight: FontWeight.bold, color: LitColors.bone, fontSize: 13.5)),
                      subtitle: Text(
  ...
  void _addAnnouncement() {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text('New Announcement', style: GoogleFonts.fredoka(color: LitColors.bone, fontSize: 16)),
        content: Column(
    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setS) => AlertDialog(
          ...
          title: Text('Report Incident', style: GoogleFonts.fredoka(color: LitColors.bone, fontSize: 16)),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              ClayTextField(controller: titleCtrl, hintText: 'Title'),
              ...
              Row(
                children: [
                  Text('Severity:', style: GoogleFonts.plusJakartaSans(color: LitColors.ash, fontSize: 12)),
                  ...
                  Text('$severity', style: GoogleFonts.fredoka(color: LitColors.bone, fontSize: 12)),
                ],
              ),
            ],
          ),
