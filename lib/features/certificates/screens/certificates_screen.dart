            ...
            IconButton(
              icon: _generating
                  ? const SizedBox(
                      width: 18,
                      height: 18,
                      child: CircularProgressIndicator(color: LitColors.ember, strokeWidth: 2),
                    )
                  : const Icon(Icons.auto_awesome, color: LitColors.bone),
                          ...
                          return ClayCard(
                            ...
                            child: Row(
                              children: [
                                ...
                                IconButton(
                                  icon: const Icon(Icons.download, color: LitColors.ember, size: 20),
                                  onPressed: () {
                                ...
                                IconButton(
                                  icon: const Icon(Icons.qr_code, color: LitColors.bone, size: 20),
                                  onPressed: () => _showQR(c),
